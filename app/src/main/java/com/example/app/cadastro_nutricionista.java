...
public class cadastro_nutricionista extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ( validarCampos()) {
                    MyPost task = new MyPost();
                    //MUDAR ENDEREÇO
                    String urlApi = "http://10.0.2.2:8000/api/nutritionist/store";
                    task.execute(urlApi);
                }
            }
        });
        ...
        if (nome.isEmpty() || email.isEmpty() || senha.isEmpty() || confirmeSenha.isEmpty()) {
            ...
            status = false;
                ...
                try{
                    ...
                    cadastro = new JSONObject();
                    cadastro.put("name",nome);
                    cadastro.put("email",email);
                    cadastro.put("password",senha);
                    cadastro.put("function", getIntent().getExtras().getString("funcao"));
                    System.out.print(cadastro.toString());
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                try (OutputStream os = urlConnection.getOutputStream()) {
                    byte[] input = cadastro.toString().getBytes("utf-8");
